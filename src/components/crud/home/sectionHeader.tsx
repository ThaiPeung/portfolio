...
const SectionHeader: React.FC<SectionHeaderType> = ({
  ...
  textNeonColor = "0 0 7px #fff, 0 0 10px #fff, 0 0 21px #fff, 0 0 42px #0fa, 0 0 82px #0fa, 0 0 92px #0fa, 0 0 102px #0fa, 0 0 151px #0fa",
  neonBorderColor = "0 0 .2rem #fff, 0 0 .2rem #fff, 0 0 2rem #bc13fe, 0 0 0.8rem #bc13fe,0 0 2.8rem #bc13fe,inset 0 0 1.3rem #bc13fe",
  textLinearColor = "",
  linearBorderColor = "",
}) => {
  return (
